...
import { TableDeleteDialogComponent } from 'app/entities/table/table-delete-dialog.component';
import { TableService } from 'app/entities/table/table.service';

describe('Component Tests', () => {
  describe('Table Management Delete Component', () => {
    let comp: TableDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TableDeleteDialogComponent, '')
        .compileComponents();
